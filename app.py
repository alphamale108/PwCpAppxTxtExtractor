...
API_ID = int(os.environ.get("API_ID", "20081897"))
API_HASH = os.environ.get("API_HASH", "8051dfd6c39c07e3eb56d58ef7f9f15f")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8437726474:AAE6-hpZIu_D3KuuwcTW0q4cmLKEbnwj-Bg")
